package net.mcreator.oxygennotcrafted;
...
@Mod("oxygen_not_crafted")
public class OxygenNotCraftedMod {
	public static final Logger LOGGER = LogManager.getLogger(OxygenNotCraftedMod.class);
	public static final String MODID = "oxygen_not_crafted";

	public OxygenNotCraftedMod() {
