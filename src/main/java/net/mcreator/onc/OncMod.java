...
@Mod("onc")
public class OncMod {
	public static final Logger LOGGER = LogManager.getLogger(OncMod.class);
	public static final String MODID = "onc";
	...
	public OncMod() {
		...
		OncModMobEffects.REGISTRY.register(bus);
